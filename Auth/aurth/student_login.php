...
if(isset($_POST['submit'])){
    ...
    $fetch = $conn->query('SELECT * FROM Users_login');
    ...
    <div class="bg-white shadow-md rounded-lg w-full max-w-4xl flex overflow-hidden">
        ...
        <div class="w-1/2 p-8">
            ...
            <div class="text-center mb-6">
                <img src="../img/eraEventManagement.png" alt="eem Logo" class="mx-auto h-16">
                <h2 class="text-xl font-bold text-green-600">Era Event Management</h2>
            </div>

            <!-- Login Tabs -->
            <div class="flex justify-center space-x-6 mb-6">
                <a href="login.php"><button class="font-semibold text-lg border-b-2 border-blue-500 text-blue-500">Users Login</button></a>
                <a href="admin_login.php"><button class="font-semibold text-lg text-gray-500 ">Admin Login</button></a>
            </div>

            <!-- Login Form -->
            <form method="POST" action="">
                <p class="text-gray-500 text-sm mb-4">Enter into <span class="font-semibold text-red-500">Users Portal</span></p>
                <?php
                    echo isset($msg)?$msg:'';
                ?>
